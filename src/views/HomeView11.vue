...
const data = reactive({
  ...
  dialogs: {
    ...
    'instRuctions': {show: false, contentShow: false},
    'copyAddress': {show: false, contentShow: false},
  } as any
})
...
watch(isConnected, async (newValue) => {
  ...
  if (newValue) {
    try {
      await switchChain({chainId: 8217});
    } catch (error) {
      console.error('切换链失败，尝试添加链', error);
      await switchChain({chainId: 8217});
...
<template>
      ...
      <div class="g_dialog">
        ...
        <div class="bottom">
          ...
          <div class="other_btns">
            ...
            <div class="btn" @click="showDialog('instRuctions')">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fff" viewBox="0 0 40 40"
                   style="fill: rgb(255, 255, 255);">
                <path fill-rule="evenodd"
                      d="M28.692 6.664v5h5a1.667 1.667 0 0 1 1.673 1.666v8.423h-3.337v-6.756h-23.7a5 5 0 0 1-1.667-.3v16.598a1.667 1.667 0 0 0 1.667 1.667h23.7v-5.605h3.337v7.271a1.667 1.667 0 0 1-1.673 1.667H8.328a5 5 0 0 1-5-5V9.997a5 5 0 0 1 5-5h18.697a1.666 1.666 0 0 1 1.667 1.667M7.15 8.819a1.67 1.67 0 0 1 1.178-.489h17.03v3.334H8.328A1.667 1.667 0 0 1 7.15 8.819"
                      clip-rule="evenodd"></path>
              ...
              <!-- instRuctions -->
            <div class="g_backdrop instRuctions" v-show="data.dialogs['instRuctions'].show">
              <div class="bg" :class="{ 'show': data.dialogs['instRuctions'].contentShow }">
                <div class="g_dialog">

                  <div class="close_button" style="text-align: right; padding: 20px 20px 0px 20px;">
                    <div style="cursor: pointer;" @click="hideDialog('instRuctions')">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="rgb(150, 150, 150)" viewBox="0 0 32 32"
                           style="width: 20px; height: 20px;">
                        <path fill-rule="evenodd"
                              d="M5.94 5.94a1.5 1.5 0 0 1 2.12 0L16 13.878l7.94-7.94a1.5 1.5 0 0 1 2.12 2.122L18.122 16l7.94 7.94a1.5 1.5 0 0 1-2.122 2.12L16 18.122l-7.94 7.94a1.5 1.5 0 0 1-2.12-2.122L13.878 16l-7.94-7.94a1.5 1.5 0 0 1 0-2.12"
                  ...
                  <div style="text-align: center;font-weight: 600;margin-bottom:20px;">
                    ...
                    <div style="overflow-y: scroll; height: 500px;">
                      ...
                      <div><img src="/src/assets/images/step_01.png"
                                ...
                                alt=""></div>
                      <!-- step_2 -->
                      <div style="color:#fff; margin-top: 20px; font-size: 16px; font-weight: bold; color: #BFF009;">
                        STEP 2
                      </div>
                      <div style="color: #6d6d6d;">Please enter the wallet name</div>
                      <div><img src="/src/assets/images/step_02.png"
                                style="width: 250px; border: 1px solid #4c5f05; padding: 5px; border-radius: 10px; "
                                alt="">
                      </div>
                      <!-- step_3 -->
                      ...
                      <div style="color: #6d6d6d;">You can see the search results</div>
                      <div><img src="/src/assets/images/step_03.png"
                                style="width: 250px; border: 1px solid #4c5f05; padding: 5px; border-radius: 10px; "
                                alt=""></div>
                      <!-- step_4 -->
                      <div style="color:#fff; margin-top: 20px; font-size: 16px; font-weight: bold; color: #BFF009;">
                      ...
                      <div style="color: #6d6d6d;">Select wallet link</div>
                      <div><img src="/src/assets/images/step_04.png"
                                style="width: 250px; border: 1px solid #4c5f05; padding: 5px; border-radius: 10px; "
                                alt=""></div>
                    </div>
                  </div>
  ...
  <div class="g_backdrop copyAddress" v-show="data.dialogs['copyAddress'].show">
    <div class="bg" :class="{ 'show': data.dialogs['copyAddress'].contentShow }">
      <div class="g_dialog">
        <div class="close_button">
          <div style="cursor: pointer;" @click="hideDialog('copyAddress')">
            <svg xmlns="http://www.w3.org/2000/svg" fill="rgb(150, 150, 150)" viewBox="0 0 32 32"
              style="width: 20px; height: 20px;">
              <path fill-rule="evenodd"
                d="M5.94 5.94a1.5 1.5 0 0 1 2.12 0L16 13.878l7.94-7.94a1.5 1.5 0 0 1 2.12 2.122L18.122 16l7.94 7.94a1.5 1.5 0 0 1-2.122 2.12L16 18.122l-7.94 7.94a1.5 1.5 0 0 1-2.12-2.122L13.878 16l-7.94-7.94a1.5 1.5 0 0 1 0-2.12"
        ...
        <div style="text-align: center;font-weight: 600;margin-bottom:20px;">
          <div>
            <img src="/public/images/logo1.svg" style="width: 90px;" alt="">
          </div>
          <div style="margin:10px;color:#fff;">Preparing in progress</div>
          <div style="margin:10px;color:#555;">Please be patient and wait for 3-5 minutes</div>
        </div>
        <div class="btn_line">
          <div class="btn_copy" @click="hideDialog('copyAddress')">Close</div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="page p2">
        ...
        <main>
          ...
          <div class="content_box1">
            ...
            <div class="font_2">
              From top-tier DeFi protocols to AAA<br/> games, real-world assets, fandoms,<br/> communities and more,
              Kaia’s <br/>vibrant ecosystem is enjoyed by millions <br/> across Asia everyday.
            </div>
      ...
      <div class="page p2">
        ...
        <main>
          ...
          <div class="content_box1">
            ...
            <div class="font_2">The Kaia Wallet app allows you to use your<br/>wallet more safely and easily through
              social login.
            </div>
