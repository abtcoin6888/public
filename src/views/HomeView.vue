...
<template>
  ...
  <!-- swapCompleted -->
  <div class="g_toast swapCompleted" :class="{ 'show': data.dialogs['swapCompleted'].contentShow }" v-show="data.dialogs['swapCompleted'].show">
    <div style="display: flex;align-items: center;">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" type="info" class="sc-goMbjt dqnqea"><path fill-rule="evenodd" d="M2.188 14C2.188 7.476 7.476 2.188 14 2.188S25.813 7.476 25.813 14 20.523 25.813 14 25.813 2.188 20.523 2.188 14m15.657-3.83a1.312 1.312 0 1 1 1.935 1.773l-6.417 7a1.313 1.313 0 0 1-1.935 0l-3.208-3.5a1.312 1.312 0 0 1 1.935-1.774l2.24 2.445z" clip-rule="evenodd"></path></svg>
  ...
  <!-- swapProgress -->
  <div class="g_toast swapProgress" :class="{ 'show': data.dialogs['swapProgress'].contentShow }" v-show="data.dialogs['swapProgress'].show">
    <div style="display: flex;align-items: flex-start;">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#57CF3F" viewBox="0 0 20 21" style="fill: rgb(64, 171, 43);"><path fill-rule="evenodd" d="M1.563 10.5a8.438 8.438 0 1 1 16.875 0 8.438 8.438 0 0 1-16.875 0m8.28-4.687a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5M8.439 9.875c0-.518.42-.937.937-.937H10c.518 0 .938.42.938.937v3.49a.938.938 0 0 1-.313 1.822H10a.937.937 0 0 1-.937-.937v-3.49a.94.94 0 0 1-.626-.885" clip-rule="evenodd"></path></svg>
      <div style="flex:1;padding:0 10px;">
          ...
          <svg
            ...
            <g clip-path="url(#__lottie_element_82)">
              ...
              <g style="display: block;"
                ...
                opacity="0.8">
                <g opacity="1" transform="matrix(1,0,0,1,-22.698999404907227,19.301000595092773)">
                  <path class="loading-svg" stroke-linecap="round" stroke-linejoin="miter" fill-opacity="0" stroke-miterlimit="4"
                        stroke="rgb(190,240,9)" stroke-opacity="1" stroke-width="49"
      ...
      <div class="g_dialog">
        ...
        <div class="confirm_box">
          ...
          <div class="coin_prs">
            ...
            <div class="c_prs">0.001</div>
            <div class="c_name">KAIA</div>
          </div>
          ...
          <div class="coin_prs" style="margin: 50px 0px 20px 0px;">
            ...
            <div class="sw_data">
              <div><strong>1</strong>KAIA</div>
              <div><strong>=0.1244</strong>USDT</div>
            </div>
          </div>
          ...
          <div class="sw_btnbox">
            ...
            <div class="btn_2">
              <div class="fmRedHatDisplay2-7" :class="{'on':data.chked}">Confirm</div>
            </div>
          </div>
  ...
  <!-- pages -->
  <swiper @swiper="onSwiper" :direction="'vertical'" :slidesPerView="1" :spaceBetween="0" :mousewheel="true" :pagination="{ clickable: true }" :modules="[Mousewheel, Pagination]">
    <swiper-slide>
      <div class="page p1">
        <header>
        ...
        <main>
          ...
          <div class="swap_box">
            ...
            <div class="ctv_box" style="display: flex; flex-flow: row nowrap; justify-content: space-between;">
            ...
            <div class="btn_box">
              ...
              <button class="btn_on">
                <div class="btn_text">Approve</div>
